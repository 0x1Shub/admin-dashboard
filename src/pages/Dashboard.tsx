    ...
    <div className="admin-container">
      ...
      <main className="dashboard">
        ...
        <section className="widget-container">
            <WidgetItem percent={40} amount={true} value={340} heading={"Revenue"} color="rgb(0, 115, 255)" />
            <WidgetItem percent={-14} amount={false} value={400} heading={"Users"} color="rgb(0, 198, 202)" />
            <WidgetItem percent={80} amount={false} value={340} heading={"Transactions"} color="rgb(255, 196, 0)" />
            <WidgetItem percent={40} amount={false} value={340} heading={"Products"} color="rgb(75, 76, 255)" />
        </section>

        <section className="graph-container">
          <div className="revenue-chart">
            <h2>Revenue & Transaction</h2>
            <BarChart data_1={[300, 144, 433, 655, 237, 755, 290]} data_2={[200, 44, 563, 355, 767, 235, 940]}
              title_1="Revenue"
              title_2="Transaction"
